...
- **Многопоточность.** При вызовах из нескольких потоков/задач синхронизацию
  обеспечивает приложение своим мьютексом; приём из ISR — lock-free и вне лока.
...
```sh
make test          # юнит + сценарные тесты (1931 проверка)
